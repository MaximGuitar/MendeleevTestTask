...
function ImgShw(ID, width, height, alt)
{
	...
	*
	* @param int $resizeType = BX_RESIZE_IMAGE_PROPORTIONAL Тип масштабирования:          <ul> <li> <b>BX_RESIZE_IMAGE_EXACT</b> - масштабирует в
	...
	*
	* @param array|false $arFilters = false Массив массивов для постобработки картинки с помощью фильтров:
