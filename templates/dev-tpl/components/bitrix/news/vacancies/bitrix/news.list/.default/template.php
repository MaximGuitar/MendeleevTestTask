...
<div class="items-grid">
	<?php foreach ($arResult["ITEMS"] as $arItem): ?>
		<div class="vacancy-card" data-micromodal-trigger="modal-vacancy-<?= $arItem["ID"] ?>">
			<h3 class="name h3"><?= $arItem["NAME"] ?></h3>
			<?php if ($arItem["DISPLAY_PROPERTIES"]["PAYMENT"]["VALUE"]): ?>
				<p class="payment darkgreen-color"><?= $arItem["DISPLAY_PROPERTIES"]["PAYMENT"]["VALUE"] ?> ₽</p>
			<?php endif ?>
			<svg class="fancy-bg" viewBox="0 0 198 270" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path d="M208.143 294L143.196 243.272L61 235.429L111.975 170.785L119.857 89L184.816 139.728L267 147.571L216.025 212.203L208.143 294Z" fill="#D9F1DB"/>
				<path d="M175.571 53L158.547 39.885L137 37.8571L150.362 21.1444L152.429 0L169.457 13.115L191 15.1429L177.638 31.8524L175.571 53Z" fill="#D9F1DB"/>
				<path d="M225.571 233L179.857 197.367L122 191.857L157.881 146.449L163.429 89L209.152 124.633L267 130.143L231.119 175.542L225.571 233Z" fill="#DBDCDF"/>
				<path d="M23.5714 154L13.1674 146.082L0 144.857L8.16592 134.766L9.42857 122L19.8346 129.918L33 131.143L24.8341 141.232L23.5714 154Z" fill="#DBDCDF"/>
			</svg>
		...
		<div class="modal modal-action modal-vacancy" id="modal-vacancy-<?= $arItem["ID"] ?>" data-micromodal-close aria-hidden="true">
			<div class="modal__overlay">
				<div class="modal__container">
					<div class="grid">
						<p class="subtitle h1 darkgreen-color"><?= $arItem["NAME"] ?></p>
						<div class="text-col">
						...
						<div class="form-col default-form-colors">
							<?= tpl("components/vacancy-form", ["status" => "init", "name" => "", "phone" => "", "vacancy" => $arItem["NAME"]]) ?>
						</div>
					</div>
